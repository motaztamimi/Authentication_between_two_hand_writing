...
if __name__ == '__main__':
    ...
    find_match_pairs(test_file, 5000, '../match_labels_from_hebrew_for_test.csv')
    find_match_pairs(train_file, 12500, '../match_labels_from_hebrew_for_train.csv')
    find_miss_match_pairs(test_file, 5000, '../miss_match_labels_from_hebrew_for_test.csv')
    find_miss_match_pairs(train_file, 12500, '../miss_match_labels_from_hebrew_for_train.csv')

    create_label_file('../match_labels_from_hebrew_for_test.csv', '../miss_match_labels_from_hebrew_for_test.csv', 5000, '../Test_labels_for_hebrew.csv')

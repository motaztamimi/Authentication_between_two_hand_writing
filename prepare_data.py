...
if __name__ == '__main__':
    ...
    # create_label_file('Train_match_labels.csv', 'Train_miss_match_labels.csv', 10000, "Train_Labels.csv")
    create_label_file('Test_match_labels.csv', 'Test_miss_match_labels.csv', 10000, "Test_Labels.csv")

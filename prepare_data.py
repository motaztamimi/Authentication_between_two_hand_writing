...
if __name__ == '__main__':
    ...
    # Delete_White_Lines()
    find_match_pairs(start=0,end=15,filename="Train_match_labels.csv")
    find_match_pairs(start=33,end=39,filename="Test_match_labels.csv")
    find_miss_match_pairs(start=0,end=15,filename="Train_miss_match_labels.csv")
    find_miss_match_pairs(start=33,end=39,filename="Test_miss_match_labels.csv")
